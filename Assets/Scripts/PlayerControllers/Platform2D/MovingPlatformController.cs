...
public class MovingPlatformController : RaycastController {
	...
	private Dictionary<Transform, PlatformPlayerController2D> passengerDictionary = new Dictionary<Transform, PlatformPlayerController2D> ();
	...
	private void MovePassengers (bool beforeMovePlatform) {
		foreach (PassengerMovement passenger in passengerMovement) {
			if (!passengerDictionary.ContainsKey (passenger.transform)) {
				passengerDictionary.Add (passenger.transform, passenger.transform.GetComponent<PlatformPlayerController2D> ());
			}
