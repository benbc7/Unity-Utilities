...
public class OpenSceneReloadMenu {
	...
	private static void GenerateOpenSceneMenuScript () {
		...
		if (myPath == null) {
			...
			var basePath = System.IO.Path.GetDirectoryName (myPath);
			var menuScriptPath = System.IO.Path.Combine (basePath, "OpenSceneMenu.cs");
			...
			foreach (var scene in scenePaths) {
				...
				var sceneNameRaw = System.IO.Path.GetFileNameWithoutExtension (scenePath);
